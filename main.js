...
const staticpath = path.join(__dirname, "public/main")
...
////////////////////find number of station count///////////////////////////////
      countKeys = Object.keys(data).length - 6;                              //
      // console.log(`Number of keys: ${countKeys}`);                        //
...
///////////////////////////////////////////////////////////////////////////////      
      ...
      for (let key in data) {                                                //
        if (key === 'S_NO.') {                                               //
          ...
          xml += `<TNAME_E>${data[key].toUpperCase().trim()}</TNAME_E>\r\n`;                      //
        }                                                                    //
        ...
        // else if (key === 'TRAIN_NAME_R_HEX'||key==='TNAME_R') {                  //
        //   xml += `<TNAME_R>${data[key]}</TNAME_R>\r\n`;                      //
        // }
        ...
        // }
          ...
          for (let i = 0; i < stringNumbers.length; i++) {                   //
            ...
            // console.log(dataKeyAsString.length)
            if (stringNumbers[i].length === 1) {                             //
              value = `0${stringNumbers[i].trim()}`                                 //
              xml += `<STOPS>${value}</STOPS>\r\n`;                          //
              xml += `<R_VIA>05</R_VIA>\r\n`;
